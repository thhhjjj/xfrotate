...
cd voice_toy
isd_download.exe -tonorflash -dev sh55 -boot 0x0 -div8 -wait 300 -uboot uboot.boot  -uboot_compress -app app.bin 0x20000 -key 111-AD15N-39E9-4A92D5E6.lkey -format all//-wflash dir_up 0 [PA05_1B_NUL0] -format all
